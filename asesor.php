...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div id="antAserores">
		<?php include "asesoresLista.php"; ?>

	</div>
<div id="overlay">
	<div class="text"><span id="hojita"><i class="bi-leaf"></i></span> <p id="pFrase"> Subiendo los datos... <span id="porcentajeSub"></span> <br> <span>«Pregúntate si lo que estás haciendo hoy <br> te acerca al lugar en el que quieres estar mañana» <br> Walt Disney</span></p></div>
</div>
</div>
...
function eliminarAsesor(idAsesor) {
	$.ajax({url: 'borrarAsesor.php', type: 'POST', data: { idAsesor}}).done(function(resp) {
		console.log(resp);
		if(resp=='todo ok'){
			location.reload();
		}
