...
$pdf->SetFont('ArialNarrow','',13.5);
$pdf->MultiCell(0,6.5, utf8_decode("Nos comprometemos a promover su propiedad utilizando los medios de difusión online (redes sociales) y offline que consideremos los más adecuados como marketing digital inmobiliario, página web,  post personalizados, videos, email marketing, volantes, módulos, banners, letreros, magazine inmobiliario, videos drone, caravanas, videos tik tok, Open House, fichas técnicas, etc. Con el soporte de nuestro Diseñador Grafico Profesional - Comunity Manager y con el objetivo de localizar a potenciales compradores siendo los gastos por nuestra empresa."), 0); $pdf->Ln();
$pdf->SetFont('Arial', 'B', 11);
...
$pdf->SetFont('ArialNarrow','',13.5);
$pdf->MultiCell(0,6.5, utf8_decode("Prestaremos asesoramiento y colaboración a todos los posibles compradores llevándolo a la propiedad, coordinando con las entidades bancarias para su calificación de compra y seguimiento hasta el otorgamiento del contrato privado o escritura pública de compraventa en la notaria, prestando los servicios profesionales necesarios para el buen fin de la operación."), 0); $pdf->Ln();
$pdf->MultiCell(0,6.5, utf8_decode("Contará con el Soporte de nuestra Coordinadora General y  de Negocios."), 0); $pdf->Ln();
...
$pdf->SetFont('ArialNarrow','',13.5);
$pdf->MultiCell(0,6.5, utf8_decode("El propietario se compromete en proporcionarnos copias del CRI actualizado, copia del Testimonio de como adquirieron el inmueble (compra venta o sucesión intestada o prescripción adquisitiva), copia del Autovaluo, copia del DNI de los Propietarios, copia de los servicios de Agua y Electricidad."), 0); $pdf->Ln();
...
$pdf->Ln();
$pdf->SetFont('Arial', 'B', 11);
$pdf->MultiCell(0,6.5, utf8_decode("AHORA EN HUANCAYO, OXAPAMPA Y LIMA, COMPRA, VENDE Y ALQUILA TU PROPIEDAD CON GARANTIA CON BOSTON ABREGÚ REALTY"), 0, 'C'); $pdf->Ln();
