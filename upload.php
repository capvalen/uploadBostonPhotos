...
$sql = "INSERT INTO `fichas`(`idFicha`, `fichTitulo`, `fichPrecio`, `fichDireccion`, `fichTipoPropiedad`, `fichAreaTerreno`, `fichAreaConstruccion`, `superficie_descubierta`, `superficie_semicubierta`, `superficie_cubierta`, `fichFrontis`, `fichDormitorios`, `fichBanios`, `medios_banios`, `fichCochera`, `fichDescipcion`, `antiguedad`, `resumen`, `beneficios`, `pisos`, `azoteas`, `area_contruccion`, `area_cochera`, `servicio_agua`, `servicio_luz`, `servicio_desague`, `mantenimiento`, `garantia`, `anticipo`, `anios`, `idAsesor`, `moneda`, `tipo_operacion`) VALUES
(null, '{$_POST['txtTitulo']}', '{$_POST['txtPrecio']}', '{$_POST['txtDireccion']}', '{$_POST['txtPropiedad']}', '{$_POST['txtATerreno']}', '{$_POST['txtAConstruccion']}', '{$_POST['txtSuperficieDescubierta']}', '{$_POST['txtSuperficieSemicubierta']}', '{$_POST['txtSuperficieCubierta']}', '{$_POST['txtFrontis']}', '{$_POST['txtDormitorios']}', '{$_POST['txtBanio']}', '{$_POST['txtMediosBanios']}', '{$_POST['txtCochera']}', '{$_POST['txtDescripcion']}', '{$_POST['txtAntiguedad']}', '{$_POST['txtResumen']}', '{$_POST['txtBeneficios']}', '{$_POST['txtPisos']}', '{$_POST['txtAzoteas']}', '{$_POST['txtAreaConstruccion']}', '{$_POST['txtAreaCochera']}', '{$_POST['txtServicioAgua']}', '{$_POST['txtServicioLuz']}', '{$_POST['txtServicioDesague']}', '{$_POST['txtMantenimiento']}', '{$_POST['txtGarantia']}', '{$_POST['txtAnticipo']}', '{$_POST['txtAnios']}', {$_POST['txtAsesor']}, '{$moneda}', '{$_POST['txtOperacion']}');";
