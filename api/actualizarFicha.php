...
$pisos = $cadena->real_escape_string($_POST['txtPisos']);
$azoteas = $cadena->real_escape_string($_POST['txtAzoteas']);
$areaContruccion = $cadena->real_escape_string($_POST['txtAreaConstruccion']);
$areaCochera = $cadena->real_escape_string($_POST['txtAreaCochera']);
$servicioAgua = $cadena->real_escape_string($_POST['txtServicioAgua']);
$servicioLuz = $cadena->real_escape_string($_POST['txtServicioLuz']);
$servicioDesague = $cadena->real_escape_string($_POST['txtServicioDesague']);
