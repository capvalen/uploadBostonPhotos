				...
				<table class="table table-hover">
					...
					<tbody id="tbodyBienes">
						...
						<tr>
							...
							<td>
								<button class="btn btn-outline-primary btn-sm" title="Comentarios" onclick="abrirModalComentarios(<?= $rowInmueble['idFicha']; ?>)"><i class="icofont-chat"></i></button>
								<?php if($_COOKIE['ckPower']==1): ?>
...
<!-- Modal para ver comentarios -->
<div class="modal fade" id="modalNuevoPrecio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
...
function abrirModalComentarios(idFicha){
	console.log('abrir')
